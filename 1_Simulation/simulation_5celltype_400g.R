...
B <- 20
save.image("./Simulation_V3/NB_400DE_5type_workspace.RData")
...
for (i in 1:B){
  ...
  save(counts,mu.list,log.foldchange,sigma.list,sigma.list2,file = paste0("./Simulation_V3/NB_400DE_5type_",i,".RData"))
  ...
  if (i == B | i == 1){
    pdf("./Simulation_V3/NB_400DE_5type_UMAP_initial.pdf",width=4,height=4,onefile = T)
  ...
  save(adjpvalue.list,time.mat,cluster.acc,cluster.labels.mat,total.memory.usage,peak.memory.usage,file = "./Simulation_V3/NB_400DE_5type_DEG.RData")
  ...
  #   cat("ERROR :",conditionMessage(e),"\n")
  # })
  # save(adjpvalue.list,time.mat,cluster.acc,cluster.labels.mat,file = "./Simulation_V3/NB_400DE_5type_DEG.RData")
  ...
  save(FS.gene.list,FS.time.mat,file = "./Simulation_V3/NB_400DE_5type_FS.RData")
  ...
  save(FS.gene.list,FS.time.mat,FS.ARI.frame,FS.DB.frame,FS.label.list,FS.SI.frame,
       ...
       total.memory.usage,peak.memory.usage,file = "./Simulation_V3/NB_400DE_5type_FS.RData")
  gc(verbose = F)
  ...
  gene.list <- list(FS.gene.list[[1]][[i]][1:400],
                    ...
                    FS.gene.list[[5]][[i]][1:400],
                    FS.gene.list[[6]][[i]][1:400],
                    FS.gene.list[[7]][[i]][1:400],
                    head(FS.gene.list[[8]][[i]],400),
                    head(FS.gene.list[[9]][[i]],400),
                    rownames(seurat.SD),
                    FS.gene.list[[10]][[i]][1:400],
                    FS.gene.list[[11]][[i]][1:400],
                    FS.gene.list[[12]][[i]][1:400])
  ...
  save(FS.gene.list,FS.time.mat,FS.ARI.frame,FS.DB.frame,FS.label.list,FS.SI.frame,
       ...
       file = "./Simulation_V3/NB_400DE_5type_FS.RData")
  gc(verbose = F)
  
  rm(list = ls())
  load("./Simulation_V3/NB_400DE_5type_workspace.RData")
  load("./Simulation_V3/NB_400DE_5type_FS.RData")
  load("./Simulation_V3/NB_400DE_5type_DEG.RData")
}
