...
nloptr(x0 = c(max(mean(x),1e-6),5),eval_f = obj.f,lb=rep(0,2),ub = rep(300,2),opts = list("algorithm"="NLOPT_LN_NELDERMEAD","ftol_rel" = 1e-9,"maxeval" = 5000,"maxtime" = 200,"xtol_rel" = 1e-4))$solution
}
...
stopCluster(cl)
save(counts.nb0,counts.nb1,counts.nb2,counts.nb3,counts.nb4,counts.nb5,counts.nb6,file = "counts_mean_r_2.RData")
