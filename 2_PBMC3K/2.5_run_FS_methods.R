...
# HVGvst ------------------------------------------------------------------
pbmc <- FindVariableFeatures(pbmc, selection.method = "vst", nfeatures = 8000,verbose = FALSE)
hvgvst <- VariableFeatures(pbmc)

# HVGdisp ------------------------------------------------------------------
pbmc <- FindVariableFeatures(pbmc, selection.method = "disp", nfeatures = 8000,verbose = FALSE)
...
save(EM,hvgvst,hvgdisp,dub,devianceFS,trendvar,file = "./results/pbmc3k_hvggenes.RData")